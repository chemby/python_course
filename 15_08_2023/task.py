...
students["Іванов Іван"] = {
    'Пошта': 'Ivanov@gmail.com',
    'Вік': 26,
    'Номер телефону': '+380687474225',
    'Середній бал': 75.4
}
...
for student in students:
    total_grade += students[student]["Середній бал"]
    if students[student]["Середній бал"] > 90:
        print(student, students[student]["Середній бал"])

    if not students[student]["Номер телефону"]:
        students[student]["Номер телефону"] = "+380123841304"

average_grade = total_grade / len(students)
print(f"Середній бал групи: {average_grade}")
